    ...
    <Layout>
       <Container maxW="container.xl">
           ...
           <Container maxW="container.md" bg="white" boxShadow="md" p={8} borderRadius="md">
             <Heading as="h1" size="xl" mb={6} textAlign="center" color="orange.500">
              CSMA CONSULT
             </Heading>
             ...
             <Stack spacing={6}>
               ...
               <Box>
                 ...
                 <Text>
                   Le site CSMA CONSULT et l&apos;ensemble de son contenu (images, vidéos, logos, etc.) sont des
                   droits de propriété intellectuelle garantis par les lois du Sénégal. Il est interdit de
