...
import { productsData } from "@app/app/lib/static-data/home/products"
  ...
  return (
    <Container maxW="container.xl" mt="28">
      ...
      <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} mt="10" spacing="10">
        {productsData.map(({ id, imageProduct, nomMateriel, icon }) => (
      ...
      <Box mt="20" textAlign="center" display={{ base: "block", md: "none" }}>
        <Button
          textTransform="uppercase"
          href="/products"
          as={NextLink}
