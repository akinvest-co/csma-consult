// import icon from "@app/app/public/images/analytics-icon.gif";
...
export const featuresData = [
  {
    ...
    icon: "ico",
    description:
      "Votre tranquillité d'esprit, des solutions qui s'harmonisent parfaitement avec vos besoins, garantissant une compatibilité sans faille.",
  },
  {
    id: 2,
    title: "Qualité",
